...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://glm.g-truc.net"
  ...
  s.author             = { "Christophe Riccio" => "glm@g-truc.net"}
  # Or just: s.author    = "stormyman"
  # s.authors            = { "stormyman" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/stormyman"
